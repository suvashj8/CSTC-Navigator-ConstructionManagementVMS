...
const mainNav: NavItem[] = [
  { to: "/dashboard", label: "Dashboard", icon: LayoutDashboard, minRole: "driver" },
  { to: "/assets", label: "Assets & Fleet", icon: Truck, minRole: "driver" },
  { to: "/allocations", label: "Allocations", icon: MapPin, minRole: "driver" },
];
...
const operationNav: NavItem[] = [
  { to: "/operations", label: "Asset operations", icon: Route, minRole: "supervisor", end: true },
...
const insightNav: NavItem[] = [
  ...
  { to: "/notifications", label: "Notifications", icon: Bell, minRole: "driver" },
];
